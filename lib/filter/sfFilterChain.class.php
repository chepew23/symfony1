...
class sfFilterChain
{
  ...
  {
    $file = sfContext::getInstance()->getConfigCache()->checkConfig('modules/'.$actionInstance->getModuleName().'/config/filters.yml');
    sfContext::getInstance()->getConfigCache()->doRequire($file, ['actionInstance' => $actionInstance]);
  }
